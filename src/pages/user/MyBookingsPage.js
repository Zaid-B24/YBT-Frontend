...
import { Loader2, AlertCircle, Ticket } from "lucide-react"; // ADDED
...
// --- 1. ADDED: Styled Components for Status & Card ---
...
// --- 2. ADDED: Styled Components for inside the Card ---
...
// --- 3. ADDED: The BookingCard Component ---
const BookingCard = ({ booking }) => {
  ...
  return (
    <Card>
      ...
      <CardContent>
        <BookingCardTitle>{booking.eventTitle}</BookingCardTitle>
        <CardDate>
          <span>
...
// --- 4. UPDATED: The BookingsPage Component ---
const BookingsPage = () => {
  const {
    data: bookings,
    isLoading,
  ...
  // Helper function to render content based on query state
  const renderContent = () => {
    // a. Loading State
    if (isLoading) {
      return (
